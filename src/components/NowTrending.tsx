...
export const NowTrending: FC<any> = ({trending}) => {

  const trendingSliced = trending.slice(0, 4);
  const baseUrl = "https://image.tmdb.org/t/p/original/";
  const [background, setBackground] = useState<string>(trendingSliced[0].backdrop_path);
