...
import { IShowOverall } from '../interfaces'

export const ShowOverall: FC<IShowOverall> = ({backdrop_path, first_air_date, last_air_date, vote_average, vote_count, original_language, number_of_seasons, number_of_episodes, popularity, type, spoken_languages, production_countries, status, keywords, externalIds}) => {
